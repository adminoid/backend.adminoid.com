...
<div id="app" class="pusher ">
    <div class="page-content">
                                                           ...
                                                           transform="translate(0.000000, 24.000000)">
                                                            ...
                                                            <g id="stripped-n"
                                                               transform="translate(80.000000, 9.000000)">
                                                                ...
                                                                <use id="n-mask" fill="#418B1B"
                                                                     xlink:href="#path-2"></use>
                                                                <g id="stripe" mask="url(#mask-3)">
                                                                    <g transform="translate(-2.000000, 0.000000)">
                                                                        <rect id="Rectangle-Green" fill="#418B1B" x="1"
        ...
        <!-- <div class="ui page container" id="pageName"></div> -->
            ...
            <div class="ui middle aligned four column grid">
                ...
                <div class="two wide column">
                    <div class="ui inverted link list">
                        <a href="#" class="item">Процесс</a>
                        <a href="#" class="item">Цена</a>
                    </div>
                </div>
                <div class="two wide column">
                    <div class="ui inverted link list">
                        <a href="#" class="item">Портфолио</a>
                        <a href="#" class="item">Инструменты</a>
                    </div>
                </div>
